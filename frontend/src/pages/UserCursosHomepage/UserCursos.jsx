    ...
    return (
                    ...
                    <CourseCard 
                        ...
                        courseInfo={
                            <p>
                                ...
                                HTTP e HTTPS;<br/>
                                E muito mais sobre o universo tech!
                            </p>
                        }
                        progressPercentage={dataMock.fs_course.progress_percentage || "1"}
            ...
            <section className='available-courses'>
                ...
                <div className='courses-grid-mobile'>
                    ...
                    <CourseCard 
                        ...
                        progressPercentage={dataMock.qa_course.progress_percentage || "0"}
                    ...
                    <CourseCard 
                        ...
                        progressPercentage={dataMock.ux_course.progress_percentage || "0"}
                        btnTxt='Iniciar trilha'
                    />
                </div>
            </section>
        ...
        <footer className='homepage-cursos-footer'>
            ...
            <div className='supporters-box'>
                <a className='fcamara-link' href="https://www.fcamara.com.br/">
